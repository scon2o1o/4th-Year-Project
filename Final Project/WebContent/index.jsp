	...
	<div id="body">
		...
		<div id="stockArea">
			<div id="topHeading">
				...
				<input id="refreshButton" type="button" value="Refresh" class="floatRight">
			</div>
			<div id="stockTable" class="rounded">
			</div>
		</div>
		<div id="totalsArea">
		<h2>Total Stock Cost: &euro;0.00</h2>
		...
		<br>
		<canvas id="linechart" width="300" height="200" class="rounded"></canvas><br><br><br>
		<canvas id="piechart" width="300" height="200" class="rounded"></canvas><br><br><br>
		<canvas id="radarchart" width="300" height="200" class="rounded"></canvas><br><br><br>
